...
if __name__ == "__main__":
    ...
    if (options.prior is not None or options.load is not None) and options.image is not None:
        ...
        if options.load is not None:
            ...
            t0 = time.time()
            #sub_iters=100
            epochs=options.iter/options.sub_iters
            ...
            for step in xrange(0, epochs):
                ...
                for sstep in xrange(options.sub_iters):
                    if options.log is not None:
                        ...
                        writer.add_summary(summary_str, step*options.sub_iters+sstep)
                    else:
                ...
                print("{} - {}  - {} {}".format(step*options.sub_iters,_loss,_variances,_means))
